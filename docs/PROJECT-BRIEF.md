...
| Claim | Status |
|---|---|
| 77 test suites pass | ✅ **verified** 2026-09-06 (chapter 130 added `collection`; 76 before it, 62 at chapter 108). A build without Drogon registers 48 — see the BaaS row. |

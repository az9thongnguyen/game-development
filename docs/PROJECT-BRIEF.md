...
| Test suites | **86, all passing** (~46 s) — headless, no window. A build without Drogon registers **57**; the 29 Drogon-gated ones run in their own CI job since chapter 129. |
...
| Guidebook chapters | 140 (`docs/book/00`–`139`) |

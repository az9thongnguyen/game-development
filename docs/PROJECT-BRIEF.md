...
it was pointed at.
**Last verified:** 2026-09-06, against commit `0e589e7` (`main`, 400 commits).
...
| `--lab map` | The Studio's Map workspace, full-screen — the SAME object as its Map tab: layers, paint/rect/fill, and the Entity tool that places a spawn. `map2` only |
...
| Claim | Status |
|---|---|
| 77 test suites pass | ✅ **verified** 2026-09-06 (chapter 132 retired `maplab` with the lab it tested: 78 at chapter 131, 62 at chapter 108). A build without Drogon registers 49 — see the BaaS row. |

...
| `docs/book/` (136 chapters) | The **explanation** of every subsystem, one chapter per feature | Before modifying a subsystem you did not write |
...
| Test suites | **81, all passing** (~80 s) — headless, no window. A build without Drogon registers **53**; the 28 Drogon-gated ones run in their own CI job since chapter 129. |
...
| Guidebook chapters | 137 (`docs/book/00`–`136`) |
...
docs/            book/ (137 chapters), strategy/ (6), guides/ (2), superpowers/{specs,plans}
...
| Claim | Status |
|---|---|
| 81 test suites pass | ✅ **verified** 2026-09-07 (chapter 136 added `test_creature`; 80 at 135 with the fourth `.hrt` door, 78 at 134, 77 at 132, 62 at 108). A build without Drogon registers 53, measured. |

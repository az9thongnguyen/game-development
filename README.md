...
./build/demo --hub-ui projects/creator.gameproject    # windowed: interactive Hub (Space publishes, 1/2 promote, R refreshes)
./build/demo --shell projects/creator.gameproject     # windowed: Studio shell — nav rail (Hub / Learn / About) over the domain
